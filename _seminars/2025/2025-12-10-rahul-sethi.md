---
speaker: Rahul Sethi (Georgia Institute of Technology, Atlanta, USA)
...
then we show
\begin{equation}
\|f\|\_{L^2\_\alpha(\mathbb{R}^+)} \lesssim \|f\|\_{L^2\_\alpha(E)},
\end{equation}
...
results. This result is applied to derive decay rates of radial solutions of the damped wave equation. This is joint work with Ben Jaye.
